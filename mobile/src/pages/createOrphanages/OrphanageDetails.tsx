...
export default function OrphanageDetails() {
  ...
  const params = route.params as RouteParamsItem;
  ...
  if(!orphanage){
    return(
      <View style={styles.container}>
        <ShimmerPlaceHolder
          style={styles.imagesShimmerContainer}
          stopAutoRun = {false}
  ...
  function handleLinkingToGoogleMaps(){
    Linking.openURL(`http://maps.google.com/maps/dir/?api=1&destination=${orphanage?.latitude},${orphanage?.longitude}`);
  }
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={handleLinkingToGoogleMaps} style={styles.routesContainer}>
